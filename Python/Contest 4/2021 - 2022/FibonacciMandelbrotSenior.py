...
test_input = [
    [0.1, 0.2, 0.4, 0.35, 0.075], [-0.1, -0.1, 0.0, 0.1, 0.05],
    [-2.5, -1.0, -2.0, 0.0, 0.05], [-0.1, -0.3, -0.05, -0.2, 0.005],
    [-0.3, -0.3, 0.2, 0.2, 0.1], [-1.5, -1.5, 1.5, 1.5, 0.2],
    [-0.4, -0.3, 0.4, 0.3, 0.06], [0.175, -0.1, 0.235, 0.4, 0.006],
    [-0.2, -0.2, 0.0, 0.5, 0.02], [-0.375, -0.1, 0.075, 0.5, 0.025]
]
