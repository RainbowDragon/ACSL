 ...
 * 5. STRING msg
 */
string fibCypher(char option, int num1, int num2, char key, string msg)
{
    int n = msg.length();

    int fibonacciNumber[200];
...
int main()
{
    string input[10][5] = 
    {
        ...
        {"E", "1", "2", "a", "Fibonacci cyphers are fun to encode and decode."},
        {"D", "4", "7", "x", "383 450 432 338 400 394 475 335 444 440 471 448 350 408 424 443 359 364 355 388 371 332 383 448 436 412 407 344 430 449 454 377 371 457 431 407 405 401 395 471 467 323 420 400 426 443 452 459 448 436 419 419 403"},
        {"D", "7", "10", "p", "434 403 409 430 421 401 323 397 342 466 392 398 463 403 424 359 429 454 353 465 413 410 362 426 453 332 425 431 419 377 418 405 466 473 362 462 414 427 430 444 434 377 427 463 471 444 470 415 417 459 400 416 427 385"},
        {"E", "16", "9", "l", "What happens when the first number is greater than the second?"},
        {"D", "11", "13", "q", "378 404 434 338 480 454 464 453 450 380 441 459 344 356 377 397 406 439 409 459 392 440 416 323 418 465 425 405 404 436 393 405 432 350 458 426 409 446 392 432 427 377 411 410 377 410 416 422 362 445 440 443 465 422 476 393 434 332 391 457 478 432 420 445 399 413 431 433 383 422 410 440 338 365 462 468 430 392 410 362 419 477 475 431 395 414 377 338 478 461 453 392 371 467 434 462 411 410 377 405 421 365 409 472 403 444 411 411 394 392 376 340 348 388 350 352 373 364"}
    };
    ...
    for (int i = 0; i < 10; i++)
    {
        string result = fibCypher(input[i][0][0], stoi(input[i][1]), stoi(input[i][2]), input[i][3][0], input[i][4]);
