...
public class ACSLBookSenior {
    ...
    static String encodeMessage (String text, String message) {
        ...
        ArrayList<String>[] wordlist = getWordList(sentenceList);

        ArrayList<String>[] keyList = getKeyList(wordlist);
    ...
    static ArrayList<String>[] getWordList (String[] sentenceList) {

        ArrayList<String>[] wordlist = new ArrayList[sentenceList.length];
    ...
    static ArrayList<String>[] getKeyList (ArrayList<String>[] wordlist) {
        ...
        for (int ns = 0; ns < wordlist.length; ns++)
    ...
    public static void main (String [] args) {
        ...
        String[] output = {
                "1.1.1 1.5.3 1.5.7 1.10.5 1.10.9 1.12.6 1.16.3 1.13.11_2.18.1 1.18.5 1.14.2 1.13.4 2.11.5 2.18.6 2.6.3 2.9.8_2.19.1 2.10.2 2.1.3 2.11.2 1.16.4 2.14.3 2.14.2_2.11.1 2.15.3 2.17.5 2.20.4 2.18.5 2.19.7_(1.1.1 2.9.1 2.19.1 2.20.1)_1.13.9 1.18.7_2.2.1 2.2.3 2.19.5!",
                "2.1.2 1.3.1 1.4.2 2.7.7 1.12.5 2.5.1 2.3.1_3.5.1 1.10.4_1.15.9 3.2.4 3.4.1 2.5.1 1.13.2 1.15.6_1.1.1 3.4.2 3.2.3 2.6.2!",
                "1.5.1 1.2.6 4.3.2 1.3.6_2.1.8 2.2.2_3.2.2 4.1.2 3.4.7_3.10.5 2.4.2 3.13.3 4.5.7 3.13.5 3.6.2 3.6.7 4.5.8_5.2.1 3.3.1_1.12.6 1.6.1_1.9.1 1.14.1!_5.1.1 5.1.5 4.1.3 4.3.4 4.1.5_3.8.1 3.2.1_3.1.4 3.12.4 3.2.6 3.4.3_4.5.5 3.8.2 5.2.3 5.3.1?",
                "6.1.1 1.9.6 1.4.4_#6.10.1_1.12.4 5.6.4 1.15.2 1.17.5 2.18.4 3.10.2_1.22.2 4.10.1_1.30.4 5.9.5 6.6.6_2.7.5 2.21.4 4.26.1 2.2.2_6.3.1 2.15.1 4.14.3_4.22.1 2.10.2 4.17.4 4.22.5_3.7.3 4.18.2 3.7.2 4.13.3_6.10.2_4.26.1 6.1.3 5.4.6 1.30.3 4.14.4 3.7.6 2.20.1_4.13.5 2.18.2 2.15.2 4.20.1!",
                "3.1.1 1.6.3 3.1.5 3.2.2 1.9.5_2.5.6 1.15.3 3.3.1_2.5.1 2.2.4_3.1.6 1.16.2 3.3.3_1.3.2_2.1.3 2.5.2 2.5.3 1.17.1_1.17.2 2.2.3_3.1.6 1.15.2 2.4.2_1.3.1_2.1.3 1.13.2 1.17.3 1.14.3?",
                ...
                "1.30.1 1.20.4 2.11.5 1.6.2_1.14.5 1.25.2 1.35.2 1.11.2;_2.14.1 1.34.5 1.34.3 2.6.11 2.3.4 1.17.3_2.5.4 1.36.2 2.14.1 2.14.1 1.34.6 2.6.6 1.24.11 2.5.6 2.5.6;_1.24.9 1.30.4_1.35.2 2.5.1 1.36.7 2.3.2!",
                "1.4.1 2.1.1_1.4.8 1.14.8_2.14.2 1.7.1 2.7.5 1.10.2_2.14.1 2.12.2_3.6.8 2.18.5 2.3.1 2.6.10!_1.5.1 1.4.5_2.30.3 3.6.2,_3.5.4 3.8.3 3.8.1_2.26.1 2.17.2 2.18.1 2.11.5_3.11.3 2.18.4 2.26.9 2.26.9_2.22.7 2.22.3_2.7.4 3.5.2 2.26.5?",
                "3.10.1 2.1.1_1.4.1 1.13.5_1.10.2 1.31.1 1.12.2 1.18.2_2.8.1 1.4.3 1.23.2 3.10.8 3.12.2_1.32.1 2.10.4 1.31.3_2.1.1 3.8.3_1.30.9 2.5.4 3.11.3 3.12.7 2.8.2 3.3.1 2.9.3 3.6.3._3.8.2 3.9.1_2.4.6 1.25.1_1.25.1 3.5.3_1.31.4 3.10.4 1.24.2?",
                "1.1.1 2.10.2 1.10.2_2.11.1 2.6.1 2.16.1 2.2.4 3.12.6_3.10.2 4.6.1_4.9.1^3.13.1+3.6.1=2.5.1_4.11.1 3.20.1 4.2.3_+3.15.1 5.12.3_5.12.1 3.27.1 1.11.6_-3.15.1 3.22.3,_3.13.1_3.23.6 5.8.3 4.10.1 3.8.9 3.26.5 5.1.2 4.13.1 3.20.1 5.8.10_3.23.8 3.12.5 3.27.3 3.12.1 4.5.3 3.26.8 5.7.2."
        };
